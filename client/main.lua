...
function LoadMarkers()
    ...
    Citizen.CreateThread(function()
        ...
        for index, value in pairs(Coordinates) do
            ...
            AddTextComponentString('Palauta')
            ...
            for id, val in ipairs(Coordinates) do
                ...
                if distance <= 5.0 then
                    ...
                    if distance <= 1.5 then
                        ESX.Game.Utils.DrawText3D({x = val.x, y = val.y, z = val.z + 1}, '[E] Palautus', 0.4)
    ...
    while true do
        ...
        if distance ~= -1 and distance <= 1.5 then
            if entity ~= nil then
                ...
                ESX.Game.Utils.DrawText3D({ x = binCoords.x, y = binCoords.y, z = binCoords.z + 1 }, '[E] Etsi Roskakori', 0.4)
                if IsControlJustReleased(0, 38) then
